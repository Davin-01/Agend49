...
const mockAnalytics = {
  ...
  agentPerformance: [
    { name: 'DataAnalyst Pro', interactions: 3200, satisfaction: 96, responseTime: 750, efficiency: 92 },
    { name: 'Customer Support', interactions: 2800, satisfaction: 98, responseTime: 450, efficiency: 95 },
    { name: 'Content Creator', interactions: 2100, satisfaction: 91, responseTime: 1200, efficiency: 87 },
    { name: 'Sales Assistant', interactions: 1900, satisfaction: 89, responseTime: 980, efficiency: 84 },
    { name: 'Code Assistant', interactions: 1650, satisfaction: 97, responseTime: 650, efficiency: 94 },
    { name: 'HR Recruiter', interactions: 800, satisfaction: 85, responseTime: 1100, efficiency: 78 }
  ],
  dailyStats: [
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Track performance and insights across your AI agents</p>
              </div>
                          ...
                          <div key={index} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 bg-muted rounded-full h-2">
                              <div 
                                ...
                                style={{ width: `${(day.interactions / 250) * 100}%` }}
                              />
                            </div>
                        ...
                        {mockAnalytics.topQueries.map((query, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-card/30 rounded-lg">
                            ...
                            <div className="text-right">
                              <div className="font-bold text-foreground">{query.count}</div>
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-foreground">{agent.satisfaction}%</span>
                              </div>
                            </div>
                              ...
                              <div className="flex items-center gap-2">
                                <div className="flex-1 bg-muted rounded-full h-2">
                                  <div 
                                    ...
                                    style={{ width: `${Math.min((1000 / agent.responseTime) * 100, 100)}%` }}
                                  />
                                </div>
                                <span className="text-sm font-medium text-foreground">{agent.responseTime}ms</span>
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-foreground">{agent.efficiency}%</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-foreground">Performance Improvement</h4>
                            <p className="text-sm text-muted-foreground mt-1">
                              Your agents' response time improved by 15% this week
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                              Customer Support agent has the highest satisfaction rate at 98%
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                              Consider upgrading memory for Content Creator to improve performance
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <Card className="bg-card/40 backdrop-blur-sm border border-border/50">
                    ...
                    <CardContent className="space-y-3">
                      <div className="p-3 bg-card/30 rounded-lg">
                        <h4 className="font-medium text-foreground text-sm mb-1">Scale Popular Agents</h4>
                        <p className="text-xs text-muted-foreground">
                          DataAnalyst Pro is in high demand. Consider creating similar agents.
                        </p>
                      </div>

                      <div className="p-3 bg-card/30 rounded-lg">
                        <h4 className="font-medium text-foreground text-sm mb-1">Improve Response Times</h4>
                        <p className="text-xs text-muted-foreground">
                          Content Creator has slower response times. Optimize its configuration.
                        </p>
                      </div>

                      <div className="p-3 bg-card/30 rounded-lg">
                        <h4 className="font-medium text-foreground text-sm mb-1">User Engagement</h4>
                        <p className="text-xs text-muted-foreground">
                          Peak usage is between 2-4 PM. Consider scheduling maintenance outside these hours.
                        </p>
                      </div>
                    </CardContent>
                  </Card>

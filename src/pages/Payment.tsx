          ...
          <motion.div variants={itemVariants} className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Unlock unlimited agents and advanced features</p>
              </div>
            </div>
          </motion.div>
                  ...
                  >
                    ...
                    <CardHeader className="text-center">
                      <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center">
                        {plan.id === 'starter' && <Zap className="w-8 h-8 text-primary" />}
                  ...
                  <TabsContent value="wallet" className="space-y-4">
                    <div className="max-w-md">
                      <div className="p-6 bg-card/30 rounded-lg text-center">
                        ...
                        <h3 className="text-lg font-semibold text-foreground mb-2">Wallet Balance</h3>
                        <div className="text-3xl font-bold text-foreground mb-2">$45.00</div>

...
const mockWalletData = {
  ...
  totalEarned: 1250.75,
  totalSpent: 1005.25,
  monthlySpending: 89.50,
  savingsGoal: 500.00,
  currentSavings: 245.50
};
...
const Wallet = () => {
  ...
  const getTransactionIcon = (category: string) => {
    ...
    return icons[category] || <DollarSign className="w-4 h-4 text-muted-foreground" />;
  };
                    ...
                    <CardContent className="space-y-4">
                      <div className="p-4 bg-card/30 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Instant top-up with Visa, Mastercard, or American Express
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium text-foreground">
                          ${mockWalletData.currentSavings.toFixed(2)} / ${mockWalletData.savingsGoal.toFixed(2)}
                        </span>
                      </div>
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <div 
                          ...
                          style={{ width: `${(mockWalletData.currentSavings / mockWalletData.savingsGoal) * 100}%` }}
                        />
                      </div>
                      
                      <div className="text-center">
                        <div className="text-2xl font-bold text-foreground">
                          {Math.round((mockWalletData.currentSavings / mockWalletData.savingsGoal) * 100)}%
                        </div>
                        <div className="text-sm text-muted-foreground">
                          ${(mockWalletData.savingsGoal - mockWalletData.currentSavings).toFixed(2)} to go
                        </div>
                      </div>

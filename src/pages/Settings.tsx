        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Customize your ncAGENTS experience</p>
            </div>
            {hasUnsavedChanges && (
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      {[
                        ...
                        { key: 'collaborationAlerts', label: 'Collaboration Alerts', description: 'Notifications for team activities' },
                        { key: 'achievementNotifications', label: 'Achievement Notifications', description: 'Celebrate your milestones' },
                        ...
                        <div key={setting.key} className="flex items-center justify-between p-4 bg-card/30 rounded-lg">
                          <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            setVoiceSettings({...voiceSettings, defaultVoice: value});
                            setHasUnsavedChanges(true);
                          }}
                        >
                          <SelectTrigger className="bg-background/50">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => {
                              setVoiceSettings({...voiceSettings, voiceOutput: checked});
                              setHasUnsavedChanges(true);
                            }}
                          />
                        </div>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-muted-foreground">{voiceSettings.speechRate[0]}x</span>
                        </div>
                        <Slider
                          value={voiceSettings.speechRate}
                          onValueChange={(value) => {
                            setVoiceSettings({...voiceSettings, speechRate: value});
                            setHasUnsavedChanges(true);
                          }}
                          max={2}
                          min={0.5}
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm text-muted-foreground">{Math.round(voiceSettings.microphoneGain[0] * 100)}%</span>
                        </div>
                        <Slider
                          value={voiceSettings.microphoneGain}
                          onValueChange={(value) => {
                            setVoiceSettings({...voiceSettings, microphoneGain: value});
                            setHasUnsavedChanges(true);
                          }}
                          max={1}
                          min={0}
              ...
              <TabsContent value="privacy" className="space-y-6">
                <Card className="bg-card/40 backdrop-blur-sm border border-border/50">
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            setPrivacySettings({...privacySettings, sessionTimeout: parseInt(e.target.value)});
                            setHasUnsavedChanges(true);
                          }}
                    ...
                    <div className="space-y-4">
                      {[
                        { key: 'dataSharing', label: 'Data Sharing', description: 'Share anonymized usage data to improve the platform' },
                        { key: 'analyticsTracking', label: 'Analytics Tracking', description: 'Allow analytics tracking for better user experience' }
                      ].map((setting) => (
                        <div key={setting.key} className="flex items-center justify-between p-4 bg-card/30 rounded-lg">
                          <div>
                            <h4 className="font-medium text-foreground">{setting.label}</h4>
              ...
              <TabsContent value="agents" className="space-y-6">
                <Card className="bg-card/40 backdrop-blur-sm border border-border/50">
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            setAgentSettings({...agentSettings, defaultMemory: value});
                            setHasUnsavedChanges(true);
                          }}
                        >
                          <SelectTrigger className="bg-background/50">
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="standard">Standard (5GB)</SelectItem>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="collaboration">Default Collaboration Mode</Label>
                        <Select
                          value={agentSettings.collaborationMode}
                          onValueChange={(value) => {
                            setAgentSettings({...agentSettings, collaborationMode: value});
                            setHasUnsavedChanges(true);
                          }}
                        >
                          <SelectTrigger className="bg-background/50">
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="task_chain">Task Chain</SelectItem>
                    ...
                    <div className="space-y-4">
                      {[
                        { key: 'autoSave', label: 'Auto-Save Agent Configurations', description: 'Automatically save changes to agent settings' },
                        { key: 'templateSharing', label: 'Template Sharing', description: 'Allow sharing of your agent templates with the community' }
                      ].map((setting) => (
                        <div key={setting.key} className="flex items-center justify-between p-4 bg-card/30 rounded-lg">
                          <div>
                            <h4 className="font-medium text-foreground">{setting.label}</h4>
                          ...
                          <Switch
                            checked={agentSettings[setting.key as keyof typeof agentSettings] as boolean}
                            onCheckedChange={(checked) => {
                              setAgentSettings({...agentSettings, [setting.key]: checked});
                              setHasUnsavedChanges(true);
                            }}
                          />
                        </div>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="p-6 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h3 className="text-xl font-semibold text-foreground">Current Plan: {billingSettings.currentPlan}</h3>
                          <p className="text-muted-foreground">Billed {billingSettings.billingCycle}</p>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        ...
                        <div>
                          <div className="text-2xl font-bold text-accent">50GB</div>
                          <div className="text-sm text-muted-foreground">Memory</div>
                        </div>
                        <div>
                          <div className="text-2xl font-bold text-green-400">Priority</div>
              ...
              <Card className="bg-red-500/5 border-red-500/20">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-red-500/10 rounded-lg border border-red-500/20">
                    ...
                    <Button variant="outline" className="text-red-500 hover:text-red-400 hover:border-red-500/50">
                      <Trash2 className="w-4 h-4 mr-2" />
                      Delete Account
                    </Button>
                  </div>

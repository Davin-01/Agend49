...
const mockNotifications = [
  ...
  },
  {
    ...
    message: 'Customer Support agent encountered an error processing request #12345',
                ...
                <AnimatePresence>
                  {filteredNotifications.length === 0 ? (
                    ...
                    filteredNotifications.map((notification, index) => (
                      ...
                      >
                        <Card className={`bg-card/40 backdrop-blur-sm border transition-all duration-300 hover:border-primary/30 ${
                          !notification.read ? 'border-primary/20 bg-primary/5' : 'border-border/50'
                        }`}>

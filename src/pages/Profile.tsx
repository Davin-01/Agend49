...
const mockAchievements = [
  { id: 1, name: "Agent Creator", description: "Created 5+ agents", icon: "🤖", earned: true },
  { id: 2, name: "Collaborator", description: "Set up team collaboration", icon: "🤝", earned: true },
  { id: 3, name: "Voice Pioneer", description: "Used voice features", icon: "🎤", earned: true },
  { id: 4, name: "Analytics Expert", description: "Viewed analytics 10+ times", icon: "📊", earned: true },
  { id: 5, name: "Community Builder", description: "Shared 3+ templates", icon: "🌟", earned: false },
  { id: 6, name: "Power User", description: "Reach level 15", icon: "⚡", earned: false }
];
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Level {mockUser.level} • {mockUser.xp} XP</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 bg-card/30 rounded-lg">
                        <div className="text-2xl font-bold text-primary">{mockStats.agentsCreated}</div>
                      ...
                      <div className="text-center p-4 bg-card/30 rounded-lg">
                        <div className="text-2xl font-bold text-yellow-400">{mockStats.achievementsEarned}</div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Level {mockUser.level} Progress</span>
                      ...
                      <div className="w-full bg-muted rounded-full h-3">
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          animate={{ width: `${(mockUser.xp / mockUser.nextLevelXp) * 100}%` }}

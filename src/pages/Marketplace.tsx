...
const mockMarketplaceAgents = [
  {
    ...
    description: 'Advanced sales automation agent with CRM integration and lead scoring',
    avatar: '💼',
    category: 'Sales',
    price: 15,
    rating: 4.8,
  ...
  },
  {
    id: 'market_3',
    name: 'Data Scientist',
    description: 'Advanced data analysis and machine learning model development',
    avatar: '📊',
    category: 'Analytics',
    price: 25,
    rating: 4.7,
  ...
  },
  {
    id: 'market_5',
    name: 'Code Assistant',
    description: 'AI pair programmer for code review, debugging, and optimization',
    avatar: '💻',
...
const Marketplace = () => {
  ...
  const categories = ['all', 'Sales', 'Content', 'Analytics', 'Support', 'Development', 'HR'];
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Discover and install powerful AI agents created by the community</p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredAgents.filter(agent => agent.featured).slice(0, 3).map((agent, index) => (
                  <motion.div
                    key={agent.id}

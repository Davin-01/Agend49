...
import { Brain, Zap, FileText, DollarSign, Users, ArrowRight } from "lucide-react";
        ...
        <nav className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-4 group">
            ...
            <span className="text-2xl font-bold text-foreground tracking-tight group-hover:text-primary transition-colors duration-300">
              nc<span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">AGENTS</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-2">
            {[
              { icon: Zap, label: "Features", href: "#features", isExternal: true },
              { icon: FileText, label: "Docs", href: "#docs", isExternal: true },
              { icon: DollarSign, label: "Pricing", href: "/pricing", isExternal: false },
              { icon: Users, label: "About", href: "/about", isExternal: false },

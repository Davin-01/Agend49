  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-dot-pattern animate-float opacity-30" style={{ backgroundSize: '20px 20px' }} />
      ...
      >
        <div className="flex items-center justify-center gap-3 bg-card/40 backdrop-blur-xl border border-green-500/20 rounded-full px-8 py-3 shadow-glow-sm">
          ...
          />
          <span className="text-sm font-medium text-foreground whitespace-nowrap">Available now, only 3 spots left</span>
        </div>
      </motion.div>
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 max-w-7xl pt-32">
          <div className="relative flex flex-col items-center text-center min-h-[calc(100vh-12rem)] justify-center w-full">
            ...
            >
              {[
                { icon: <Brain className="w-6 h-6 text-primary" />, label: "Smart Memory", desc: "Advanced AI memory" },
                { icon: <Users className="w-6 h-6 text-primary" />, label: "Multi-Agent", desc: "Team collaboration" },
                { icon: <Zap className="w-6 h-6 text-primary" />, label: "Fast Deploy", desc: "Instant deployment" },
                { icon: <Shield className="w-6 h-6 text-primary" />, label: "Secure Web3", desc: "Blockchain ready" },
                ...
                <motion.div
                  ...
                  transition={{ delay: 1.1 + i * 0.1, duration: 0.5, type: "spring", stiffness: 100 }}
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <span className="block text-lg font-semibold text-foreground group-hover:text-primary transition-colors duration-300">{label}</span>

  ...
  const testimonials = [
    {
      ...
      content: "ncAGENTS has revolutionized how we approach AI agent development. The multi-agent collaboration features are game-changing for complex problem-solving.",
      rating: 5,
    },
    {
      id: 2,
      ...
      content: "The seamless blockchain integration and advanced memory capabilities have accelerated our development timeline by months. Absolutely incredible platform.",
      rating: 5,
    },
    {
      id: 3,
      ...
      content: "The intelligent agent coordination and expert panel features have transformed our research capabilities. This is the future of AI development.",
      rating: 5,
    },
    {
      id: 4,
      ...
      content: "Outstanding Web3 integration and security features. The Stellar wallet functionality works flawlessly with our existing infrastructure.",
      rating: 5,
    },
    {
      id: 5,
      ...
      content: "Fast deployment and intuitive interface make ncAGENTS perfect for both technical and non-technical team members. Highly recommended!",
      rating: 5,
    },
    {
      id: 6,
      ...
      content: "The platform's reliability and 99.9% uptime have been crucial for our production deployments. Exceptional performance and support.",
      rating: 5,
    },
  ];
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        >
          <motion.h2 
            ...
            viewport={{ once: true }}
          >
            What Our <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">Users Say</span>
          </motion.h2>
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Join thousands of developers and organizations who trust ncAGENTS for their AI agent development needs
          </motion.p>
        </motion.div>
              ...
              >
                {visibleTestimonials.map((testimonial, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <Card className={`h-full bg-card/40 backdrop-blur-sm border transition-all duration-300 relative overflow-hidden ${

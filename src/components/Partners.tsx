...
const Partners = () => {
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-dot-pattern opacity-10" style={{ backgroundSize: '30px 30px' }} />
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-muted-foreground">Ecosystem Partners</span>
          </motion.div>
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Trusted by <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">Leading Partners</span>
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Collaborating with innovative companies across the AI ecosystem to build the future of intelligent agents
          </motion.p>
        </motion.div>
